...
| `disabled`          | `#3f3f46` (zinc-700)                   | Disabled buttons/inputs — _tái sử dụng có chủ đích_ từ `border`. Disabled state exempt khỏi WCAG AA contrast requirement              |
...
| `text-muted`        | `#71717a` (zinc-500)                  | Meta text — 4.5:1 trên bg-card ✅ _(đã fix từ #a1a1aa)_. **Không dùng cho input placeholder**                      |
...
| `disabled`          | `#d4d4d8` (zinc-300)                  | Disabled — _tái sử dụng có chủ đích_ từ `border`. Disabled state exempt khỏi WCAG AA                               |
| `disabled-text`     | `#a1a1aa` (zinc-400)                  | Text on disabled elements — exempt WCAG AA                                                                         |
| `success`           | `#16a34a`                             | Status text                                                                                                        |
| `warning`           | `#b45309` (amber-700)                 | Warning text — 5.2:1 trên bg-card ✅ _(đã fix từ #d97706)_                                                         |
