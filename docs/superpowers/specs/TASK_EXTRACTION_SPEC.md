...
Loại bỏ câu hội thoại tác nghiệp tức thì.
3. Luồng Vận hành Dữ liệu (Workflow)
...
Nếu task_id là null → Thêm bản ghi mới vào DB và sinh ID mới.
4. Cấu hình Modelfile & System Prompt Chuẩn hóa
