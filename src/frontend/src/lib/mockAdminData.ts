...
export const initialDepartments: DepartmentNode[] = [
  {
    ...
    name: "Ban Giám Đốc",
    code: "BOD",
    description: "Ban Lãnh đạo cấp cao, chỉ đạo định hướng chiến lược chuyển đổi số và bảo mật dữ liệu.",
    managerName: "System Admin",
    managerEmail: "admin@axiom.com",
    managerAvatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=120&auto=format&fit=crop&q=80",
    memberCount: 3,
  ...
  },
  {
    ...
    code: "ENG-AI",
    description: "Đội ngũ phát triển hạ tầng WebRTC LiveKit, AI Whisper STT, và kiến trúc microservices.",
  ...
  },
  {
    ...
    code: "PROD-UX",
    description: "Nghiên cứu hành vi người dùng, chuẩn hóa luồng họp trực tuyến và giao diện không gian họp.",
...
export const initialSecurityLogs: SecurityAuditEntry[] = [
  ...
  },
  {
    ...
    details: "Tự động trích xuất 6 Action Items từ phiên họp 'Review Sprint 18' và đồng bộ sang Jira.",
    severity: "INFO",
  ...
  },
  {
    ...
    ipAddress: "127.0.0.1",
    details: "Gửi webhook 'meeting.finished' tới https://api.enterprise-erp.internal/webhooks thành công (HTTP 200).",
    severity: "INFO",
    timestamp: "1 giờ trước",
  },
  {
...
export const initialApprovals: ExecutiveApprovalItem[] = [
  {
    ...
    date: "Hôm nay, 14:30",
    aiSummary: "Cuộc họp đã thống nhất chuyển đổi kiến trúc SFU sang mô hình phân tán (Distributed SFU) nhằm đáp ứng tải 500 phòng họp đồng thời. Cần phê duyệt kinh phí trang bị thêm cụm máy chủ GPU nội bộ và chốt thời hạn kiểm thử tải trước 25/10.",
    keyDecisions: [
  ...
  },
  {
    ...
    date: "Hôm nay, 11:15",
    aiSummary: "Khối Sản Phẩm đã hoàn thành Prototype tính năng Agenda Gatekeeper tự động khóa phòng họp nếu thiếu chương trình làm việc. Đề xuất Giám đốc ban hành quy chế thử nghiệm nội bộ trong 2 tuần.",
    keyDecisions: [
  ...
  },
  {
    ...
    date: "Hôm qua, 16:45",
    aiSummary: "Khách hàng yêu cầu cam kết thời gian đáp ứng hỗ trợ kỹ thuật On-Premise 24/7 (SLA 99.99%) và mức chiết khấu gói bảo trì năm 1 là 10%. Khối Kinh Doanh trình Giám đốc phê duyệt điều khoản này.",
    keyDecisions: [
