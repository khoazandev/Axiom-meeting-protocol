...
export const MOCK_DEPARTMENTS_CAPACITY: DepartmentCapacityMetric[] = [
  ...
  },
  {
    ...
    overloadedCount: 2,
    bottlenecksAlert:
      'Tải khối đạt 92%, nhiều lịch họp đối tác ngân hàng cần bổ sung nhân sự hỗ trợ',
...
export const DEPARTMENT_OPTIONS: Array<{
  ...
  {
    code: 'ENG',
    name: 'Khối Kỹ Thuật (Engineering & AI)',
    managerName: 'Trần Minh Khoa',
    defaultHours: 40,
  },
  {
    code: 'PROD',
    name: 'Khối Sản Phẩm & UX (Product Design)',
    managerName: 'Lê Thị Hồng Nhung',
    defaultHours: 25,
  },
  {
    code: 'BIZ',
  ...
  {
    code: 'OPS',
    name: 'Khối Vận Hành & Bảo Mật (SecOps & IT)',
    managerName: 'Nguyễn Thị Mai',
    defaultHours: 20,
  },
];
...
export const TEAM_MEMBERS_DIRECTORY = [
  ...
  },
  {
    id: 'mem-03',
    name: 'Elena Rostova',
    email: 'elena.r@axiom.com',
    role: 'QA & Performance Specialist',
    dept: 'ENG',
  },
  {
    id: 'mem-04',
    name: 'Nguyễn Văn Toàn',
    email: 'toan.nguyen@axiom.com',
