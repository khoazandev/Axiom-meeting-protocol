  ...
  return (
    <div className="animate-in fade-in duration-500">
      ...
      <DocSection title="Tại sao doanh nghiệp chọn Axiom?" id="why">
        <p>
          Trong môi trường doanh nghiệp hiện đại, các cuộc họp thường diễn ra phân mảnh, thiếu kỷ
          luật nghị trình và tiềm ẩn nguy cơ rò rỉ dữ liệu khi sử dụng các nền tảng đám mây công
          cộng. Axiom giải quyết triệt để các vấn đề này theo triết lý <strong>H-P-D-I</strong>:
        </p>
      ...
      <DocSection title="Kiến trúc hệ thống H-P-D-I" id="architecture">
        <p>
          Axiom được thiết kế theo kiến trúc module phân lớp rõ ràng, đảm bảo độ trễ thấp và khả
          năng chịu tải cao:
        </p>

        <Alert type="info" title="Lưu ý về Bảo mật & Xử lý thời gian thực">
          Luồng âm thanh từ mic của người tham gia được phân đoạn qua WebAudio API và truyền tải qua
          WebSocket <code>/ws/realtime-stt</code> tới backend để Faster-Whisper int8 xử lý ngay tức
          thì.
        </Alert>
...
+-------------------+       +---------------------+       +----------------------+`}
      ...
      <DocSection title="Bắt đầu từ đâu?" id="next-steps">
        <p>
          Để làm quen và làm chủ quy trình làm việc với Axiom DX-OS, bạn có thể thực hiện theo các
          bước sau:
        </p>
