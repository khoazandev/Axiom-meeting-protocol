...
export function HeroSection() {
  return (
    <section className="px-6 md:px-12 pt-24 pb-24 md:pt-24 md:pb-32 max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center min-h-[calc(100vh-64px)]">
      <div className="space-y-8 max-w-xl relative z-10">
        <div className="space-y-6">
          <SplitText
            text="Intelligent meeting protocol."
