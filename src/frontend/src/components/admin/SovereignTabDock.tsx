...
const TABS: TabItem[] = [
  {
    ...
    icon: "radar",
    badge: "3 Đang họp",
    badgeColor: "bg-emerald-100 text-emerald-800 dark:bg-emerald-950/80 dark:text-emerald-300 border-emerald-300/50",
    isLive: true,
  },
  {
    id: "members",
    ...
    badge: "10 người",
    badgeColor: "bg-blue-100 text-blue-800 dark:bg-blue-950/80 dark:text-blue-300 border-blue-300/50",
  },
  {
    id: "departments",
    ...
    icon: "account_tree",
    badge: "5 khối",
    badgeColor: "bg-purple-100 text-purple-800 dark:bg-purple-950/80 dark:text-purple-300 border-purple-300/50",
  },
  {
    id: "policies",
    ...
    icon: "gavel",
    badge: "6 chính sách",
    badgeColor: "bg-amber-100 text-amber-800 dark:bg-amber-950/80 dark:text-amber-300 border-amber-300/50",
  },
  {
    id: "audit",
    ...
    icon: "security",
    badge: "ISO/IEC",
    badgeColor: "bg-rose-100 text-rose-800 dark:bg-rose-950/80 dark:text-rose-300 border-rose-300/50",
  },
  {
    id: "webhooks",
    label: "Tích hợp & API",
    ...
    icon: "webhook",
    badge: "3 Endpoints",
    badgeColor: "bg-cyan-100 text-cyan-800 dark:bg-cyan-950/80 dark:text-cyan-300 border-cyan-300/50",
  },
];
...
export function SovereignTabDock({
  activeTab,
  onTabChange,
}: SovereignTabDockProps) {
  return (
    <nav
          ...
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {/* Tab Label */}
                <span className="tracking-tight whitespace-nowrap text-xs">
                  {tab.label}
                </span>
