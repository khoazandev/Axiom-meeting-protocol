                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-xl p-3 border border-slate-200/70 shadow-sm h-full">
                  <div className="flex items-center justify-between pb-1.5 border-b border-slate-100">
                    ...
                    <div className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-50/80 border border-emerald-200/80">
                      ...
                      <span className="text-[9.5px] font-mono font-bold text-emerald-700 ml-1.5">
                        &lt;180ms
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="my-1.5 p-2.5 rounded-lg bg-slate-50 border border-slate-200/60">
                    ...
                    <p className="text-[11px] text-slate-800 leading-relaxed font-medium">
                      &ldquo;Hạ tầng LiveKit SFU cục bộ đã triển khai xong. Toàn bộ luồng thoại
                      WebRTC và video nội bộ được mã hóa E2EE, không chuyển tiếp bất kỳ gói tin nào
                      ra internet bên ngoài.&rdquo;
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-[9.5px] text-slate-500 bg-blue-50/60 px-2.5 py-1 rounded-md border border-blue-100">
                    <MaterialIcon
                      name="translate"
                      className="w-3.5 h-3.5 text-[#4F7BF7] shrink-0"
                    />
                    <span className="italic text-slate-600 truncate">
                      EN: &ldquo;The local LiveKit SFU infrastructure has been deployed. All audio
                      and video streams are E2EE encrypted...&rdquo;
                    </span>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-[10px]">
                      ...
                      <div className="flex justify-between py-0.5">
                        ...
                        <span className="font-bold font-mono text-emerald-700 bg-emerald-100 px-1.5 rounded">
                          0.00% Zero
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pb-1.5 border-b border-slate-100 mb-1.5">
                      <div className="flex items-center gap-1.5">
                        ...
                        <h4 className="text-[12px] font-bold text-slate-900">
                          Tiến Trình Nghị Trình Cuộc Họp
                        </h4>
                      </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex items-center justify-between py-1 px-2 rounded-lg bg-slate-50 border border-slate-200/70">
                        <div className="flex items-center gap-1.5">
                          ...
                          />
                          <div>
                            <p className="text-[10.5px] font-bold text-slate-800 line-through">
                              1. Đánh giá kiến trúc WebRTC On-Premise
                            </p>
                            <span className="text-[8.5px] text-slate-400">
                              Thời lượng: 10 phút • Hoàn thành đúng hạn
                            </span>
                          </div>
                        </div>
                        <span className="text-[8.5px] font-bold text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded">
                          Đã duyệt
                        </span>
                      </div>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <div>
                            <p className="text-[11px] font-bold text-blue-950">
                              2. Triển khai phân tách người nói & Silero VAD
                            </p>
                            <span className="text-[9px] text-blue-700 font-medium">
                              Đang thảo luận • Còn 04:15
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <div>
                            <p className="text-[10.5px] font-medium text-slate-600">
                              3. Xuất biên bản MoM & giao việc Kanban
                            </p>
                            <span className="text-[8.5px] text-slate-400">
                              Khóa tự động cho đến khi Mục 2 hoàn tất
                            </span>
                          </div>
                        </div>
                ...
                <div className="w-full md:w-[260px] bg-white rounded-xl p-3 border border-slate-200/70 shadow-sm flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-[10px] text-slate-600 leading-relaxed">
                      Ngăn chặn tình trạng họp lan man hoặc kéo dài vô tận. Người chủ trì buộc phải
                      có nghị trình được phê duyệt trước khi phòng họp mở cửa.
                    </p>
                  </div>
              ...
              >
                  ...
                  <div>
                    <div className="flex items-center justify-between pb-1.5 border-b border-slate-100 mb-1.5">
                      <div className="flex items-center gap-1.5">
                        ...
                        <h4 className="text-[12px] font-bold text-slate-900">
                          Biên Bản Cuộc Họp Tự Động (Auto MoM)
                        </h4>
                      </div>
                    ...
                    <div className="p-2 rounded-lg bg-purple-50/60 border border-purple-200/80 mb-1.5">
                      ...
                      <p className="text-[10.5px] font-semibold text-slate-800">
                        Thống nhất cấu hình máy chủ LiveKit SFU nội bộ, bảo toàn 100% dữ liệu mật
                        không gửi ra dịch vụ ngoài.
                      </p>
                    </div>
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between py-1 px-2 rounded-lg bg-slate-50 border border-slate-200">
                        <div className="flex items-center gap-1.5">
                          <span className="text-[8.5px] font-mono font-bold text-blue-700 bg-blue-100 px-1 py-0.2 rounded">
                            AX-104
                          </span>
                          <span className="text-[10.5px] font-semibold text-slate-800">
                            Triển khai cụm LiveKit SFU server
                          </span>
                        </div>
                        <div className="flex items-center gap-1.5 text-[9.5px]">
                          <span className="text-slate-500">Hoàng TM</span>
                          <span className="text-[8px] font-bold text-rose-700 bg-rose-50 px-1 py-0.2 rounded border border-rose-200">
                            High
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between py-1 px-2 rounded-lg bg-slate-50 border border-slate-200">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[10.5px] font-semibold text-slate-800">
                            Kiểm thử Silero VAD với 50 mic đồng thời
                          </span>
                        </div>
                        <div className="flex items-center gap-1.5 text-[9.5px]">
                ...
                <div className="w-full md:w-[260px] bg-white rounded-xl p-3 border border-slate-200/70 shadow-sm flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-[10px] text-slate-600 leading-relaxed">
                      AI tự động nhận dạng cam kết trong lời thoại (&ldquo;tôi sẽ phụ trách phần này
                      trước thứ Sáu&rdquo;) để tự động tạo vé việc rõ ràng kèm người chịu trách
                      nhiệm và thời hạn.
                    </p>
                  </div>
              ...
              >
                  ...
                  <div>
                    <div className="flex items-center justify-between pb-1.5 border-b border-slate-100 mb-1.5">
                      <div className="flex items-center gap-1.5">
                        <MaterialIcon name="security" className="w-3.5 h-3.5 text-emerald-600" />
                        <h4 className="text-[12px] font-bold text-slate-900">
                          Bảo Mật & Chủ Quyền Dữ Liệu On-Premise
                        </h4>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[10.5px]">
                      ...
                      <div className="p-2 rounded-lg bg-slate-50 border border-slate-200">
                        ...
                        <p className="text-slate-500 text-[9.5px] leading-relaxed">
                          Mã hóa E2EE chuẩn quân sự từ luồng WebRTC đến cơ sở dữ liệu lưu trữ biên
                          bản cuộc họp.
                        </p>
                      </div>
                    </div>
                ...
                <div className="w-full md:w-[260px] bg-white rounded-xl p-3 border border-slate-200/70 shadow-sm flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-[10px] text-slate-600 leading-relaxed">
                      Khác biệt với Zoom, Teams hay Google Meet, toàn bộ model AI Whisper và LLM đều
                      chạy trên GPU tại chỗ, dữ liệu không bao giờ rời khỏi tường lửa nội bộ.
                    </p>
                  </div>
