        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              <span className="flex items-center gap-1"><Calendar className="w-3 h-3" /> {new Date(meeting.start_time).toLocaleDateString()}</span>
        ...
        <div className="w-full lg:w-[400px] xl:w-[450px] bg-muted/30 border-l border-border/40 flex flex-col shrink-0 overflow-y-auto">
          <div className="p-6 space-y-6">
            ...
            <section className="space-y-3 pt-6 border-t border-border/40">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Intelligence (AI)</h3>
              ...
              <Card className="border-border/50 shadow-none bg-background">
                <CardContent className="p-4 flex flex-col items-center justify-center text-center space-y-2 h-32">
                   ...
                   <p className="text-xs text-muted-foreground">Real-time transcripts and action items will be generated when the meeting ends.</p>
                </CardContent>
              </Card>
            </section>
