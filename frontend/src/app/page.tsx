    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground selection:bg-primary/20">
      ...
      <header className="flex items-center justify-between h-20 px-6 md:px-12 border-b border-border/40">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground">
          ...
          <Link href="/meetings" className="hover:text-foreground transition-colors">Dashboard</Link>
        </nav>
        <div>
      ...
      <main className="flex-1">
          ...
          <div className="space-y-8 max-w-xl">
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-[45ch]">
                On-premise video conferencing with native AI intelligence. Enforce agendas, transcribe securely, and capture structural data—zero external cloud dependency.
              </p>
            </div>
        ...
        {/* Features Bento Grid */}
        <section id="features" className="px-6 md:px-12 py-24 bg-zinc-50 dark:bg-zinc-900/20 border-t border-border/40">
          <div className="max-w-[1400px] mx-auto space-y-16">
            <div className="max-w-2xl space-y-4">
              <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">Structured by design.</h2>
              <p className="text-lg text-muted-foreground">Every meeting follows the H-P-D-I architectural pattern, ensuring alignment before anyone joins the call.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-background p-8 rounded-2xl border border-border/50 space-y-4 shadow-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">Integrated WebRTC video conferencing that runs entirely on your infrastructure.</p>
              </div>
              ...
              <div className="bg-background p-8 rounded-2xl border border-border/50 space-y-4 shadow-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">Local Whisper models capture every word. Llama-3 distills action items and decisions.</p>
              </div>
              ...
              <div className="bg-background p-8 rounded-2xl border border-border/50 space-y-4 shadow-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">Your intellectual property never leaves your servers. True On-Premise security.</p>
              </div>
            </div>
          </div>
        </section>
